...
package com.codeazur.utils
{
	...
	public class AIRRemoteUpdater extends EventDispatcher
	{
		...
		protected function getLocalVersion():String {
			...
			if (version == null || version == "") {
				var r11:Namespace = new Namespace("http://ns.adobe.com/air/application/1.1");
				var version:String = NativeApplication.nativeApplication.applicationDescriptor.r11::version.text();
			}
			return version;
		}
